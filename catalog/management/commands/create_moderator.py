...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            moderator_group, created = Group.objects.get_or_create(name='Product Moderator')
            ...
            self.stdout.write(self.style.SUCCESS(f'Successfully created moderator user: {username}'))
